  ...
  return (
    <Layout>
      <div className={"gallery"}>
        ...
        <img className={"underConstruction"} src={construction} height={"70%"} alt={<FormattedMessage id={"projects.underConstruction"} defaultMessage={"Drawing: page under construction"}/>} loading="lazy"/>

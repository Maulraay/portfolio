  ...
  return (
    <Layout>
      <div className={"gallery"}>
        ...
        <img className={"underConstruction"} src={"/assets/underConstruction.webp"} height={"70%"} alt={intl.formatMessage({id: "projects.underConstruction", defaultMessage: "Drawing: page under construction"})}/>
